...
const Compresie = () => {
  return (
    <div>
      <h1>Informații generale referitoate la compresie</h1>
      <p>
        industry.Section 1.10.32 of "de Finibu
        <br />s Bonorum et Malorum", written by Cicero in 45 BC "Sed ut persp
        <br />
        iciatis unde omnis iste natus error sit voluptatem accusantium
        doloremque laudantium, t<br />
        otam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi
        archi
        <br />
        tecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia
        volu
        <br />
        ptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni
        ...
        <br />
        "But I must explain to you how all <br />
        this mistaken idea of deno
        <br />
        uncing pleasure and praising pain was born and I will give you a
        complete account
        <br /> of the system, and expound the actual teachings of the <br />
        ...
        resultant pleasure?" Section 1.10.33 o<br />f "de Finibus Bonorum et
        Malorum", written by Cicero in 45 BC "At vero eos et accusamus et iusto
        odio dig
        <br />
        nissimos ducimus qui blanditiis praesentium voluptatum
        <br /> deleniti atque corrupti quos dolores et q<br />
        uas molestias excepturi sint occaecati cupiditate non provi
        <br />
        dent, similique sunt in culpa qui officia deserunt mollitia animi, id
        ...
        dislike men who are so beguiled and demoralized by the charms of pleas
        <br />
        ure of the moment, so blinded by desire, that they cannot foresee the
        pain and trouble that are bound to ensue; and equal
        <br /> blame belongs to those who fail in their duty through weakness of
        ...
        else he endures pains to avoid worse pains." Lorem Ipsum has been the
